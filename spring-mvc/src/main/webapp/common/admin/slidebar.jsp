...
<!-- Sidebar -->
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item dropdown"><a
				...
				aria-expanded="false"> <i class="fas fa-fw fa-folder"></i> <span>Quản lí DS bài viết</span>
			</a>
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					<h6 class="dropdown-header">Login Screens:</h6>
					<a class="dropdown-item" href='<c:url value="/quan-tri/bai-viet/danh-sach"/>'>DS bài viết</a> <a
